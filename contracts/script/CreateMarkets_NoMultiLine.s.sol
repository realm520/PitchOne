...
contract CreateMarkets_NoMultiLine is Script {
    ...
    function run() external {
        ...
        createdMarkets.push(createScoreMarket(factory, "EPL_2024_SC_1", "Liverpool", "Brighton", 13));
        createdMarkets.push(createScoreMarket(factory, "EPL_2024_SC_2", "Man Utd", "Aston Villa", 14));
        createdMarkets.push(createScoreMarket(factory, "EPL_2024_SC_3", "Chelsea", "Wolves", 15));
    ...
    function createScoreMarket(
        ...
        bytes memory initData = abi.encodeWithSignature(
            ...
            matchId, homeTeam, awayTeam,
            block.timestamp + dayOffset * 1 days,
            uint8(5), USDC, FEE_ROUTER, 200, 2 hours, 1000 * 1e18, probs,
